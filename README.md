...
* Open a terminal in `[your project]/node-modules/node-simconnect` and run `npm run rebuild`.
...
**Note for MSFS 2020:** After running `npm run rebuild` you will need to manually copy the `SimConnect.dll` from your SimConnect folder into the `build/Release` folder.
